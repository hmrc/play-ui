...
class TrackingConsentConfig @Inject()(configuration: Configuration) {
  val trackingConsentBaseUrl: Option[String] = configuration.getOptional[String](s"tracking-consent-frontend.url")
  val optimizelyBundle: Option[String] =
    configuration.getOptional[String]("tracking-consent-frontend.snippets.optimizely")
  val gtmContainer: Option[String] = configuration.getOptional[String]("gtm.container")
